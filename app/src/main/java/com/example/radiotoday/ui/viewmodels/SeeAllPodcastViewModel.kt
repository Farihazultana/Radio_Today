...
class SeeAllPodcastViewModel @Inject constructor(private val repository: SeeAllPodcastRepository) : ViewModel() {
    private val _seeAllPodcastData = MutableLiveData<ResultType<SeeAllPodcastResponse>>(ResultType.Loading)
    val seeAllPodcastData : LiveData<ResultType<SeeAllPodcastResponse>> = _seeAllPodcastData
